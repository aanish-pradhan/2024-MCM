...
```{r}
findPeaks(lowess(1:300, temp$momentumDelta, f = 0.1)$y)
```
...
```{r}
plot(1:45, set1Momentum[, 1] - set1Momentum[, 2], type = 'l')
plot(1:94, set2Momentum[, 1] - set2Momentum[, 2], type = 'l')
plot(1:70, set3Momentum[, 1] - set3Momentum[, 2], type = 'l')
plot(1:64, set4Momentum[, 1] - set4Momentum[, 2], type = 'l')
plot(1:61, set5Momentum[, 1] - set5Momentum[, 2], type = 'l')
```

```{r}
acf(set1Momentum[, 1] - set1Momentum[, 2])
acf(set2Momentum[, 1] - set2Momentum[, 2])
acf(set3Momentum[, 1] - set3Momentum[, 2])
acf(set4Momentum[, 1] - set4Momentum[, 2])
acf(set5Momentum[, 1] - set5Momentum[, 2])
```
...
model <- lm(momentumShift ~ 0, data = mswmData)

autocorrelationTerms <- 7
switchingTerms <- rep(TRUE, autocorrelationTerms + 2)
